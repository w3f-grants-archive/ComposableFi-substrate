...
mod tests {
	...
	fn test_multi_leaf_mmr_proof() {
		...
		let leaves = hex!("").to_vec();
		let proof = hex!("").to_vec();
		...
		for leaf in leaves.iter() {
			let leaf: Leaf  = codec::Decode::decode(&mut &leaf.0[..]).unwrap();
			println!("{:#?}\n\n", leaf)
		}

		let leaves = leaves
			.into_iter()
			.map(|(encoded, index)| (sp_core::keccak_256(&encoded), index))
			.collect::<Vec<_>>();

		let mmr_leaves = leaves
			.into_iter()
			.map(|(leaf, _)| DataOrHash::<sp_runtime::traits::Keccak256, Leaf>::Hash(leaf.into()))
			.collect::<Vec<_>>();
